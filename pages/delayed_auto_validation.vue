  ...
  <div>
    <section>
      <form @submit.prevent="onSubmit()" class="mt-6" method="post">
        <h1 class="mb-1 is-size-3">Delayed auto validation</h1>
